                ...
                {suggestionPrompts.map(({title, prompt}) => (
                    <CarouselItem key={title} className="basis-auto pl-1">
                      <div className="p-1">
                        <Badge 
                            variant="outline" 
                            className="font-normal border-primary/20 bg-card hover:bg-accent hover:border-primary/30 transition-all text-muted-foreground hover:text-accent-foreground cursor-pointer"
